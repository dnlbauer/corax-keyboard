  ...
  body: p => {
    ...
    function pins(def_neg, def_pos, def_side) {
      if(p.hotswap) {
        return `
          ${''/* corner marks */}
          (fp_line (start -7 -6) (end -7 -7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start -7 7) (end -6 7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start -6 -7) (end -7 -7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start -7 7) (end -7 6) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start 7 6) (end 7 7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start 7 -7) (end 6 -7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start 6 7) (end 7 7) (layer ${def_side}.SilkS) (width 0.15))
          (fp_line (start 7 -7) (end 7 -6) (layer ${def_side}.SilkS) (width 0.15))      
